...
export function Topbar({ onOpenMobileNav }: { onOpenMobileNav: () => void }) {
    ...
    return (
        <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center gap-4 border-b border-tint/[0.06] bg-background/80 px-4 backdrop-blur-xl lg:px-8">
            <button
                type="button"
            ...
            <div className="relative hidden md:block">
                ...
                <input
                    ...
                    className={cn(
                        ...
                        'hover:border-tint/[0.12]',
                        'focus:w-72 focus:border-accent/50 focus:bg-tint/[0.05] focus:outline-none focus:ring-4 focus:ring-accent/10',
                    )}
                />
                <kbd className="pointer-events-none absolute right-3 top-1/2 hidden -translate-y-1/2 rounded border border-tint/[0.08] bg-tint/[0.04] px-1.5 py-0.5 font-sans text-[10px] font-medium text-muted-foreground lg:block">
                    ⌘K
                </kbd>
            </div>
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <button
                        type="button"
                        className="flex items-center gap-2.5 rounded-md p-1 pr-2 transition-colors duration-200 hover:bg-tint/[0.05] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60"
                    >
                        <Avatar className="h-8 w-8 ring-1 ring-tint/10">
