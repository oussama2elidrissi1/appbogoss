...
export const CATEGORIES: CategoryConfig[] = [
    ...
    },
    {
        ...
        badge: 'border-sky-400/25 bg-sky-400/[0.12] text-sky-600 dark:text-sky-300',
        usesServiceCatalog: true,
    },
    {
        value: 'massage',
        ...
        badge: 'border-violet-400/25 bg-violet-400/[0.12] text-violet-600 dark:text-violet-300',
        usesServiceCatalog: true,
    },
    {
        value: 'boisson',
    ...
    },
    {
        ...
        badge: 'border-rose-400/25 bg-rose-400/[0.12] text-rose-600 dark:text-rose-300',
        usesServiceCatalog: true,
    },
    {
        value: 'autre',
        ...
        badge: 'border-tint/[0.08] bg-tint/[0.06] text-muted-foreground',
