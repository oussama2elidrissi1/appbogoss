    ...
    return (
        <EmployeePageShell>
            <div>
                ...
                <p className="text-sm text-white/50">Retours clients rattaches a vos prestations.</p>
            </div>
            <EmployeePanel>
                <EmployeePanelTitle title="Avis clients" icon={Star} />
                <div className="p-4">
                    {!data || data.summary.count === 0 ? (
                        ...
                        <>
                            <div className="mb-4 rounded-md border border-[#c8a24c]/25 bg-[#c8a24c]/10 p-4">
                                ...
                                <p className="text-sm text-white/50">Base sur {data.summary.count} avis</p>
                            </div>
