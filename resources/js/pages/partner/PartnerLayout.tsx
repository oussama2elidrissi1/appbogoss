...
interface PartnerNavSection {
    /** Omitted for the top-level "Tableau de bord" entry — it isn't grouped under a heading. */
    heading?: string;
    items: PartnerNavItem[];
}

const NAV_SECTIONS: PartnerNavSection[] = [
    { items: [{ label: 'Tableau de bord', to: '/partner/dashboard', icon: LayoutDashboard, end: true }] },
    {
        ...
        items: [
            ...
            { label: 'Mon agenda', to: '/partner/agenda', icon: CalendarDays },
        ],
    },
