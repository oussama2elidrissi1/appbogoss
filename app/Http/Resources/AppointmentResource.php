...
class AppointmentResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'proposal_note' => $this->proposal_note,
            ...
            'reservation_items' => $items->map(fn (array $item) => [
                ...
                'price_snapshot' => isset($item['price_snapshot']) ? (float) $item['price_snapshot'] : null,
                'commission_snapshot' => isset($item['commission_snapshot']) ? (float) $item['commission_snapshot'] : null,
                'duration_minutes_snapshot' => isset($item['duration_minutes_snapshot']) ? (int) $item['duration_minutes_snapshot'] : null,
                'service' => $serviceModels->get($item['service_id']) ? [
