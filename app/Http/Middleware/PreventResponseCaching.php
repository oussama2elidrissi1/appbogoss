...
class PreventResponseCaching
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // LiteSpeed's server-level page cache (LSCache) ignores standard
        // Cache-Control unless this header is present — see public/.htaccess
        // for the belt-and-suspenders "CacheLookup off" directive too.
